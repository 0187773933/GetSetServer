...
HASH_FILE="git.hash"
CONTAINER_NAME="public-get-set-server"
GITHUB_REPO="https://github.com/0187773933/GetSetServer"
...
REMOTE_HASH=$(git ls-remote https://github.com/0187773933/GetSetServer.git HEAD | awk '{print $1}')
